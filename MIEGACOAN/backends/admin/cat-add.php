...
if (!preg_match($regex, $_POST['name']) || !preg_match($regex, $_POST['short_desc']) || !preg_match($regex, $_POST['long_desc'])) {
	...
	$name = $_POST['name']; //untuk memanggil data yang sudah diinputkan agar bisa ditampilkan 
	$short_desc = $_POST['short_desc'];
	$long_desc = $_POST['long_desc'];

	$sql = "INSERT INTO categories(name,short_desc,long_desc) VALUES(?,?,?)"; //menambahkan data yang sudah diinputkan kedalam query sql
