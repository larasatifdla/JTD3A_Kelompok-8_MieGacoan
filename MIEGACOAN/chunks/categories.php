...
<section class="fcategories">
	...
	<div class="container">
		...
		<div class="section white center">
			<h3 class="header">ADA APA AJA SIH?</h3>
		</div>
			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/pict<?php echo $j; ?>.jpg">
				    </div>
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>Ini tuh makanan paling populer di Resto Mie Gacoan! Tapi semuanya populer sih, soalnya kan enak! <3 </p>
			        </div>
				    </div>
