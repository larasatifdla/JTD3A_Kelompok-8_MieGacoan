...
<section class="fcategories">
	...
	<div class="container">
		...
		<div class="section white center">
			<h3 class="header">MAU PESEN APA? KLIK AJA!</h3>
		</div>
			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
							<p>Ngiler nggak? Ngiler dong... Makanya buruan order sebelum kehabisan!</p>
			        </div>
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #ee6e73;" class="btn waves-effect waves-block waves-light" href="">PESAN SEKARANG!</a>
			        </div>
				    </div>
